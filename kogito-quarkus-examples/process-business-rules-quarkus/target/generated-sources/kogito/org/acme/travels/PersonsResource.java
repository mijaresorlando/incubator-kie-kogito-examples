...
@Path("/persons")
@org.eclipse.microprofile.openapi.annotations.tags.Tag(name = "persons")
...
public class PersonsResource {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(summary = "persons", description = "")
    public PersonsModelOutput updateModel_persons(@PathParam("id") String id, @javax.validation.Valid() @javax.validation.constraints.NotNull() PersonsModelInput resource) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(summary = "persons", description = "")
    public PersonsModelOutput updateModelPartial_persons(@PathParam("id") String id, @javax.validation.Valid() @javax.validation.constraints.NotNull() PersonsModelInput resource) {
