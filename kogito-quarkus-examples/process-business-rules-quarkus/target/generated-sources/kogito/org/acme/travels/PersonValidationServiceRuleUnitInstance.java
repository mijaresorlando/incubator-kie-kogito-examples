...
public class PersonValidationServiceRuleUnitInstance extends ReteEvaluatorBasedRuleUnitInstance<org.acme.travels.PersonValidationService> {
    ...
    public PersonValidationServiceRuleUnitInstance(RuleUnit<org.acme.travels.PersonValidationService> unit, org.acme.travels.PersonValidationService workingMemory, ReteEvaluator reteEvaluator, RuleConfig ruleConfig) {
        super(unit,
              workingMemory,
              reteEvaluator,
              ruleConfig);
